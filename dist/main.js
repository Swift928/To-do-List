...
function displayProjectTasks(item){
    ...
    if (todayView){
        ...
        todayList = (0,_upcoming__WEBPACK_IMPORTED_MODULE_1__.filterTasksByDateRange)(todayList)
    }
